...
export default function Gallery() {
  ...
  const galleryItems: { id: number, category: string, url: string, type: 'image' | 'video' }[] = [
    ...
    { id: 4, category: "beauty", url: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&q=80&w=800", type: 'image' },
    { id: 5, category: "beauty", url: "https://images.unsplash.com/photo-1560869713-7d0a29430803?auto=format&fit=crop&q=80&w=800", type: 'image' },
