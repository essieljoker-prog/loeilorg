      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-6 group">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium hover:text-gold transition-colors cursor-pointer">+229 46 56 43 01</p>
                </div>
              </div>
          ...
          <motion.div 
            ...
            className="bg-card p-8 md:p-12 rounded-[3rem] shadow-2xl shadow-ink/5 border border-beige relative"
          >
            {status === 'success' ? (
